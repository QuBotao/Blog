var tools = require('./JavaScriptTools/JavaScriptTools.js');
require('./home.css');
...
function login(){
    var d = document.getElementById('wrapperc'); 
    var b = document.getElementById('css');
    b.setAttribute("href","../out/index.css");
    d.style.display='block';
}

var a = document.getElementById('link');
tools.addEvent(a,'click',login);